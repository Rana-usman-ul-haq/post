...
contract ShitPost is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    address payable public _taxWallet = payable(0x31b5B830a8B02D79b1933ce7aBDe74230BA3908e); //Put Tax Wallet here


    uint256 private _buyTax = 7; //Buy fee
    uint256 private _sellTax = 7; // sell fee


    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 100000000 * 10**_decimals; // Total supply
    string private constant _name = unicode"The Shitpost Cartel";  // Name
    string private constant _symbol = unicode"$SHITPOST"; // Symbol
    uint256 public _maxWalletSize = 1000000 * 10**_decimals; // maxWalletlimit
    ...
    function changeMaxWalletLimit(uint256 amount) public onlyOwner {
        require(amount > totalSupply().div(200));
